                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xl-8 col-md-7">
                                            <input class="form-control " id="validationCustom1" type="text"
                                                required="" name="url1" value="{{ $clients->url1 }}" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-xl-3 col-md-4">
                                        ...
                                        <div class="col-xl-8 col-md-7">
                                                ...
                                                <img src="{{ asset('uploads/pub/' . $clients->image) }}" alt="" width="170" height="100" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-xl-3 col-md-4">
                                            <label for="validationCustom3"><span>*</span>Message </label>
                                        </div>
                                        <div class="col-xl-8 col-md-7">
                                            <input class="form-control " id="validationCustom3" type="text"
                                                required="" name="message1" value="{{ $clients->message1 }}" readonly>
                                        </div>
                                    </div>
