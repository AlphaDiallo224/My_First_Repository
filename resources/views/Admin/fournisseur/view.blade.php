                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-xl-8 col-md-7">
                                        <input class="form-control " id="validationCustom0" type="text"
                                            required="" name="prenom" value="{{$fournisseurs->prenom}}" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-xl-3 col-md-4">
                                    ...
                                    <div class="col-xl-8 col-md-7">
                                        <input class="form-control " id="validationCustom1" type="text"
                                            required="" name="nom" value="{{$fournisseurs->nom}}" readonly>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-xl-8 col-md-7">
                                        <input class="form-control " id="validationCustom2" type="email"
                                            required="" name="email" value="{{$fournisseurs->email}}" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-xl-3 col-md-4">
                                    ...
                                    <div class="col-xl-8 col-md-7">
                                        <input class="form-control " id="validationCustom3" type="text"
                                            required="" name="tel" value="{{$fournisseurs->tel}}" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-xl-3 col-md-4">
                                    ...
                                    <div class="col-xl-8 col-md-7">
                                        <input class="form-control " id="validationCustom4" type="text"
                                            required="" name="adresse" value="{{$fournisseurs->adresse}}" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-xl-3 col-md-4">
                                    ...
                                    <div class="col-xl-8 col-md-7">
                                        <input class="form-control " id="validationCustom4" type="text"
                                            required="" name="nom_entreprise" value="{{$fournisseurs->nom_entreprise}}" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-xl-3 col-md-4">
                                    ...
                                    <div class="col-xl-8 col-md-7">
                                        <input class="form-control " id="validationCustom4" type="text"
                                            required="" name="specialite" value="{{$fournisseurs->specialite}}" readonly>
                                    </div>
                                </div>
