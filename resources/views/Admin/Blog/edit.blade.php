                ...
                <div class="card-body">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade active show" id="account" role="tabpanel"
                            ...
                            <form class="needs-validation user-add" novalidate="" action="{{ route ('blog.update', $expertises->id) }}" method="POST" enctype="multipart/form-data" >
                                @csrf
                                @method('put')
                                <h4> Details</h4>
                                ...
                                <div class="form-group row">
                                    <div class="col-xl-3 col-md-4">
                                        <label for="validationCustom1"><span>*</span>TITRE</label>
                                    </div>
                                    <div class="col-xl-8 col-md-7">
                                        <input class="form-control " id="validationCustom1" type="text"
                                            required="" name="titre" value="{{$expertises->titre}}">
                                    </div>
                                    </div>
                                <div class="form-group row">
                                    <div class="col-xl-3 col-md-4">
                                        <label for="validationCustom1"><span>*</span>DETAILS</label>
                                    </div>
                                    <div class="col-xl-8 col-md-7">
                                        <input class="form-control " id="validationCustom1" type="text"
                                            required="" name="detail" value="{{$expertises->detail}}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-xl-3 col-md-4">
                                    ...
                                    <div class="col-xl-8 col-md-7">
                                        <input class="form-control" id="vali3" type="file"  name="image" 
                                            required=""value="{{("uploads/Blog/" . $expertises->image)}}">
                                    </div>
                                </div>
