                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-xl-8 col-md-7">
                                        <input class="form-control " id="validationCustom0" type="text"
                                            required="" name="titre" value="{{$clients->titre}}" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-xl-3 col-md-4">
                                    ...
                                    <div class="col-xl-8 col-md-7">
                                        <input class="form-control " id="validationCustom1" type="text"
                                            required="" name="detail" value="{{$clients->detail}}" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-xl-3 col-md-4">
                                    ...
                                    <div class="col-xl-8 col-md-7">
                                            ...
                                            <img src="{{ asset('uploads/Expertise/' . $clients->image) }}" alt="" width="170" height="100" readonly>
                                    </div>
                                </div>
