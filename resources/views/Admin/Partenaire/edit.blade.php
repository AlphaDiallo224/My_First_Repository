                ...
                <div class="card-body">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade active show" id="account" role="tabpanel"
                            ...
                            <form class="needs-validation user-add" novalidate="" action="{{ route ('partenaire.update', $expertises->id) }}" method="POST" enctype="multipart/form-data" >
                                @csrf
                                @method('put')
                                <h4> Details</h4>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-xl-8 col-md-7">
                                        <input class="form-control" id="vali3" type="file"  name="image" 
                                            required=""value="{{("uploads/Partenaire/" . $expertises->image)}}">
                                    </div>
                                </div>
