                                ...
                                <form class="needs-validation user-add" novalidate="" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xl-8 col-md-7">
                                            <input class="form-control " id="validationCustom0" type="text"
                                                required="" name="nom" value="{{ $slides->nom }}" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xl-8 col-md-7">
                                                ...
                                                <img src="{{ asset('uploads/Slide/' . $slides->image) }}" alt="" width="170" height="100" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-xl-3 col-md-4">
                                            <label for="validationCustom3"><span>*</span>Message1 </label>
                                        </div>
                                        <div class="col-xl-8 col-md-7">
                                            <input class="form-control " id="validationCustom3" type="text"
                                                required="" name="message1" value="{{ $slides->message1 }}" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-xl-3 col-md-4">
                                            <label for="validationCustom4"><span>*</span> message2</label>
                                        </div>
                                        <div class="col-xl-8 col-md-7">
                                            <input class="form-control " id="validationCustom4" type="text"
                                                required="" name="message2" value="{{ $slides->message2 }}" readonly>
                                        </div>
                                    </div>
