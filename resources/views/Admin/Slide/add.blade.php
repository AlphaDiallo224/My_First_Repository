                ...
                <div class="card-body">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade active show" id="account" role="tabpanel"
                            ...
                            <form class="needs-validation user-add" novalidate="" action="{{route('Slide.store')}}" method="POST" enctype="multipart/form-data" >
                                @csrf
                                <h4>slide Details</h4>
                                ...
                                <div class="form-group row">
                                    <div class="col-xl-3 col-md-4">
                                        <label for="validationCustom1"><span>*</span>url1</label>
                                    </div>
                                    <div class="col-xl-8 col-md-7">
                                ...
                                <div class="form-group row">
                                    <div class="col-xl-3 col-md-4">
                                        <label for="validationCustom1"><span>*</span>url2</label>
                                    </div>
                                    <div class="col-xl-8 col-md-7">
                                        <input class="form-control " id="validationCustom1" type="text"
                                            required="" name="url2">
                                ...
                                <div class="form-group row">
                                    <div class="col-xl-3 col-md-4">
                                        <label for="validationCustom2"><span>*</span> Message 1</label>
                                    </div>
                                    <div class="col-xl-8 col-md-7">
                                ...
                                <div class="form-group row">
                                    <div class="col-xl-3 col-md-4">
                                        <label for="validationCustom3"><span>*</span>Message 2 </label>
                                    </div>
                                    <div class="col-xl-8 col-md-7">
