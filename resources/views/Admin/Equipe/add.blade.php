                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade active show" id="account" role="tabpanel"
                                ...
                                <form class="needs-validation user-add" novalidate="" action="{{ route('equipe.store') }}"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-xl-3 col-md-4">
                                            <label for="validationCustom3"><span>*</span> PRENOM </label>
                                        </div>
                                        <div class="col-xl-8 col-md-7">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-xl-3 col-md-4">
                                            <label for="validationCustom4"><span>*</span> POSTE</label>
                                        </div>
                                        <div class="col-xl-8 col-md-7">
