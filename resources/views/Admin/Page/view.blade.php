                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xl-8 col-md-7">
                                            <input class="form-control " id="validationCustom1" type="text"
                                                required="" name="url" value="{{ $clients->url }}" readonly>
                                        </div>

                                    </div>
                                    <div class="form-group row">
                                        <div class="col-xl-3 col-md-4">
                                            <label for="validationCustom2"><span>*</span> CONTENUE</label>
                                        </div>
                                        <div class="col-xl-8 col-md-7">
                                            <input class="form-control " id="validationCustom2" type="contenu"
                                                required="" name="contenu" value="{{ $clients->contenu }}" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-xl-3 col-md-4">
                                        ...
                                        <div class="col-xl-8 col-md-7">
                                                ...
                                                <img src="{{ asset('uploads/Pages/' . $clients->image) }}" alt="" width="170" height="100" readonly>
                                        </div>
                                    </div>
